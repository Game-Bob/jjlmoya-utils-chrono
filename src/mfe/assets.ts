...
const UTILITY_ASSET_ROOT = "/_utilities/chrono";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/chrono/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/chrono/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("chrono");
