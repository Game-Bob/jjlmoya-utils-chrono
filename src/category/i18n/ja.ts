...
export const content: CategoryLocaleContent = {
  ...
  seo: [
    ...
    { type: "title", text: "時間という素材", level: 2 },
    {
      type: "paragraph",
      html: `時計は時刻だけを表示するものではありません。張力、温度、リズム、そして使われた時間の履歴を抱えています。だからこのページは観測所として設計されています。数字から入り、歯車を追い、比率を比べ、動きにしばらく目を留めてください。すべてのツールが、見えない操作を目と手で理解できる場面へ変えていきます。`,
    },
    { type: "title", text: "何度でも戻れるライブラリ", level: 2 },
    {
      type: "paragraph",
      html: `急がずにコレクションを巡り、問いが変わったらまた戻ってきてください。ガイドは購入の準備を助け、計算機は直感を確かめ、ビジュアライザーはケースの中に隠れているものを見せます。ここにあるのは、必要なときは正確で、眺めるときは繊細な、開かれた時計学のアトラスです。`,
    },
    {
      type: "stats",
      items: [
