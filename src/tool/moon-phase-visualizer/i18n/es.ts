  ...
  schemas: [
    ...
    },
    {
      ...
      '@type': 'SoftwareApplication',
       'name': 'Visualizador de fases lunares',
      'operatingSystem': 'All',
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'HowTo',
       'name': 'Cómo visualizar las fases lunares',
      'step': [
        {
          '@type': 'HowToStep',
           'name': 'Selecciona una fecha',
           'text': 'Usa el selector de fecha para elegir cualquier día y ver la fase lunar.',
        },
        {
          '@type': 'HowToStep',
           'name': 'Lee los datos de la fase',
           'text': 'Las tarjetas muestran el nombre de la fase, la iluminación, la edad lunar y el progreso del ciclo.',
        },
        {
          '@type': 'HowToStep',
           'name': 'Ajusta tu reloj',
           'text': 'Usa la fase mostrada para ajustar la complicación de fase lunar del reloj.',
        },
      ],
    },
  ],
