...
export const content: ToolLocaleContent<WatchSizeComparatorUI> = {
  ...
  title: 'Saat Boyut Karşılaştırıcı–Bileğinizde Görsel Uyum',
  ...
  seo: [
    { type: 'title', text: 'Saat Boyut Karşılaştırıcı-Bileğinizde Görsel Uyum', level: 2 },
