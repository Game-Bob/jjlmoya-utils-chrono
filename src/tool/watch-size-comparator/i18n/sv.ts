...
export const content: ToolLocaleContent<WatchSizeComparatorUI> = {
  ...
  title: 'Klockstorleksjamforare: se hur en klocka sitter pa handleden',
  ...
  seo: [
    { type: 'title', text: 'Klockstorleksjamforare: se hur en klocka sitter pa handleden', level: 2 },
