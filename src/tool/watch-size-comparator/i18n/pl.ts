...
export const content: ToolLocaleContent<WatchSizeComparatorUI> = {
  ...
  title: 'Porównywarka rozmiarów zegarków – wizualne dopasowanie na nadgarstek',
  ...
  seo: [
    { type: 'title', text: 'Porównywarka rozmiarów zegarków – wizualne dopasowanie na nadgarstek', level: 2 },
